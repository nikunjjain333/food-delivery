...
export default function ProfileScreen({ navigation }: any) {
  ...
  const getRoleBadgeColor = () => {
    return user?.role === 'ADMIN' ? '#a855f7' : colors.primary;
  };
    ...
    <ScrollView style={commonStyles.container}>
      <View style={{ paddingHorizontal: 24, paddingTop: 48, paddingBottom: 24 }}>
        ...
        <View style={{ alignItems: 'center', marginBottom: 32 }}>
          ...
          <View style={{ paddingHorizontal: 16, paddingVertical: 8, borderRadius: 999, backgroundColor: getRoleBadgeColor(), flexDirection: 'row', alignItems: 'center' }}>
            {getRoleIcon()}
        ...
        <View style={[commonStyles.card, { marginBottom: 24 }]}>
          ...
          <View>
            <View style={{ marginBottom: 16 }}>
              ...
              {isEditing ? (
                <TextInput
                  style={[commonStyles.input, { backgroundColor: colors.border, paddingHorizontal: 16, paddingVertical: 12, borderRadius: 12 }]}
                  value={name}
        ...
        <View style={[commonStyles.card, { marginBottom: 24 }]}>
          ...
          {changingPassword && (
            <View style={{ marginTop: 16 }}>
              <TextInput
                style={[commonStyles.input, { backgroundColor: colors.border, paddingHorizontal: 16, paddingVertical: 12, borderRadius: 12, marginBottom: 12 }]}
              ...
              />
              <TextInput
                style={[commonStyles.input, { backgroundColor: colors.border, paddingHorizontal: 16, paddingVertical: 12, borderRadius: 12, marginBottom: 16 }]}
          ...
          <View style={[commonStyles.card, { marginBottom: 24 }]}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <View style={{ flex: 1, marginRight: 8 }}>
                <Text style={{ fontSize: 30, fontWeight: 'bold', color: colors.primary }}>{stats.totalOrders}</Text>
                <Text style={{ color: colors.textSecondary, fontSize: 14, marginTop: 4 }}>Total Orders</Text>
              </View>
              <View style={{ flex: 1, marginLeft: 8 }}>
                <Text style={{ fontSize: 30, fontWeight: 'bold', color: colors.primary }}>₹{stats.totalSpent.toLocaleString()}</Text>
        ...
        {/* Logout Button */}
        <TouchableOpacity
          style={{ backgroundColor: 'rgba(239, 68, 68, 0.1)', borderWidth: 1, borderColor: colors.error, paddingVertical: 20, borderRadius: 16, alignItems: 'center', flexDirection: 'row', justifyContent: 'center' }}
